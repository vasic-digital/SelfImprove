# SelfImprove - AI self-improvement module: RLHF, reward modeling, preference optimization.
...
challenge:
	../challenges/scripts/selfimprove_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "SelfImprove - AI self-improvement module: RLHF, reward modeling, preference optimization."
	@echo ""
	@echo "Build & Test:"
